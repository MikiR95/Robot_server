...
bool rover_interfaces__msg__motor_control__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rover_interfaces.msg._motor_control.MotorControl", full_classname_dest, 48) == 0);
  }
  rover_interfaces__msg__MotorControl * ros_message = _ros_message;
  {  // speed
...
PyObject * rover_interfaces__msg__motor_control__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rover_interfaces.msg._motor_control");
